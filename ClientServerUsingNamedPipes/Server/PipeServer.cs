...
namespace ClientServerUsingNamedPipes.Server
{
    public class PipeServer : ICommunicationServer
    {
        ...
        private string _pipeName; //changed upsidedown for FS telemetry server 03/24
        ...
        public void setPipeName(string name) //added upsidedown for FS telemetry server 03/24
        {
            _pipeName = name;
        }
